...
function ManageBookingContent() {
  ...
  // const findBookingByRef = useCallback(async (ref: string) => {
  // setIsLoading(true);
  // setMessage("");
  // setBooking(null);
  ...
  //   const response = await fetch(`/api/bookings/${cleanRef}`);
  ...
  async function handleSearch(event: FormEvent<HTMLFormElement>) {
  event.preventDefault();
  await findBookingByRef(bookingRef);
  }
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-5 rounded-lg bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-slate-600">
            Enter a booking reference to view or cancel a booking.
          </p>
          ...
          <form onSubmit={handleSearch} className="mt-6 flex flex-col gap-4 md:flex-row">
            ...
            >
              {isLoading ? "Searching..." : "Manage Booking"}
            </button>
          </form>
