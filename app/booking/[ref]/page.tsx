  ...
  return (
    <main className="min-h-screen bg-slate-100 px-6 py-10">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-5 rounded-2xl bg-white p-8 shadow-sm">
          <div className="border-b border-slate-200 pb-6">
            ...
            <p className="mt-2 inline-block rounded-xl bg-slate-900 px-5 py-3 text-2xl font-bold tracking-wide text-white">
              {booking.bookingRef}
            </p>
          </div>
